...
import 'package:spotify_item_mwlatt/library_values.dart'
    as spotify_item_mwlatt_library_values;
...
void main() async {
  ...
  final spotify_item_mwlattAppState =
      spotify_item_mwlatt_app_state.FFAppState();
  await spotify_item_mwlattAppState.initializePersistedState();
  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(
        create: (context) => spotify_item_mwlattAppState,
      ),
    ],
    child: MyApp(),
  ));
