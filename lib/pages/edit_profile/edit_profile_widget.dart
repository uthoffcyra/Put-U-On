  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (valueOrDefault(currentUserDocument?.userName, '') != '') {
        logFirebaseEvent('editProfile_set_form_field');
        safeSetState(() {
                      ...
                      child: Column(
                        ...
                        children: [
                          InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'EDIT_PROFILE_PAGE_Stack_snvu8twj_ON_TAP');
                              logFirebaseEvent(
                              ...
                              children: [
                                ...
                                if (false)
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'EDIT_PROFILE_PAGE_birthdayselect_ON_TAP');
                                      logFirebaseEvent(
                                ...
                                Stack(
                                  children: [
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'EDIT_PROFILE_CONNECT_SPOTIFY_BTN_ON_TAP');
                                        if (isWeb) {
                                          logFirebaseEvent(
                                              'Button_launch_u_r_l');
                                          await launchURL(
