                      ...
                      StreamBuilder<List<LikedSongsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<LikedSongsRecord>
                              globalListLikedSongsRecordList = snapshot.data!;
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ClipRRect(
                                        ...
                                        child: Image.network(
                                          globalListLikedSongsRecord.coverArt,
                                          width: 80.0,
                                          height: 80.0,
                                          fit: BoxFit.cover,
                                        ),
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          await launchURL(
                                              globalListLikedSongsRecord.url);
                                        },
                                      ),
                    ...
                    if (_model.viewName == 'Friends')
                      StreamBuilder<List<LikedSongsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<LikedSongsRecord>
                              friendListLikedSongsRecordList = snapshot.data!;
                                    ...
                                    children: [
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.network(
                                          friendListLikedSongsRecord.coverArt,
                                          width: 80.0,
                                          height: 80.0,
                                          fit: BoxFit.cover,
                                        ),
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          logFirebaseEvent(
                                              'IconButton_launch_u_r_l');
                                          await launchURL(
                                              friendListLikedSongsRecord.url);
                                        },
                                      ),
                                    ].divide(SizedBox(width: 20.0)),
                                  ),
